...
// Alerting subsystem
const ALERTS_ENABLED = (process.env.ALERTS_ENABLED || 'false').toLowerCase() === 'true';
const ALERTS_EVALUATOR_POLL_MS = parseInt(process.env.ALERTS_EVALUATOR_POLL_MS || '15000', 10);
const ALERTS_DELIVERY_POLL_MS = parseInt(process.env.ALERTS_DELIVERY_POLL_MS || '5000', 10);
const ALERTS_MAINTENANCE_POLL_MS = parseInt(process.env.ALERTS_MAINTENANCE_POLL_MS || '60000', 10);
const ALERTS_RULE_BATCH_SIZE = parseInt(process.env.ALERTS_RULE_BATCH_SIZE || '25', 10);
const ALERTS_DELIVERY_BATCH_SIZE = parseInt(process.env.ALERTS_DELIVERY_BATCH_SIZE || '50', 10);
const ALERTS_DELIVERY_MAX_ATTEMPTS = parseInt(process.env.ALERTS_DELIVERY_MAX_ATTEMPTS || '6', 10);
const ALERTS_DELIVERY_BASE_RETRY_MS = parseInt(process.env.ALERTS_DELIVERY_BASE_RETRY_MS || '5000', 10);
