...
const { startAlertWorkers, stopAlertWorkers } = require('./services/alertsWorkers');
const { APP_ENV, RETENTION_ENABLED, METRICS_ENABLED, METRICS_MAX_TIME_RANGE_DAYS, METRICS_MAX_DATAPOINTS, ALERTS_ENABLED, tz } = require('./config');
...
const server = app.listen(port, async () => {
  ...
  if (ALERTS_ENABLED) console.log('Alerts: enabled');
